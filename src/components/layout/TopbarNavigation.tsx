...
import { Search, Bell, User, ChevronDown, LogOut, Settings, LayoutDashboard, Mail, School, Users, GraduationCap, FileText, Building2, ClipboardList, Archive, BarChart3 } from "lucide-react";
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "flex items-center gap-1 px-2 py-1 text-[11px] font-medium rounded-md transition-colors whitespace-nowrap",
                  isActive
